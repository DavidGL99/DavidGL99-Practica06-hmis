...
import java.net.URL;
public class LinkedinGuilleTest {
  ...
  @Test
  public void linkedinguille() {
    // Test name: linkedin-guille
    ...
    // 3 | click | id=linkedin-guille | 
    driver.findElement(By.id("linkedin-guille")).click();
  }
}
